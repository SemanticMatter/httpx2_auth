...
def test_corresponding_oauth2_implicit_flow_id_token_instance(monkeypatch):
    ...
    okta = httpx2_auth.OktaImplicitIdToken(
        "testserver.okta-emea.com", "54239d18-c68c-4c47-8bdd-ce71ea1d50cd"
    )
    assert (
        okta.grant_details.url == "https://testserver.okta-emea.com/oauth2/default/v1/authorize?"
    ...
    assert okta.authorization_url == "https://testserver.okta-emea.com/oauth2/default/v1/authorize"
